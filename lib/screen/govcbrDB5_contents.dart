            ...
            child: Padding(
              ...
              child:  Column(
                children: [
                    ...
                    SizedBox(
                        ...
                        child: ElevatedButton(
                          onPressed: () async {
                            ...
                            if (selectedDate != null) {
                              setState(() {
                                item?.SSD_DB7_DAY = DateFormat('yyyy-MM-dd').format(selectedDate);
                              });
                            }
                          },
                          style: ElevatedButton.styleFrom(
                  ...
                  Row (
                    ...
                    children: [
                      ElevatedButton(onPressed: () async {
                        ...
                        if(ret.toString() == "OK") {
                          ret = await _sendCheckRepository.checkDoEnd(widget.docNo, "3", false);
                  ...
                  Expanded(child:
                  FreightList(docno: widget.docNo, docdiv:"GOVCBRDB5FreightList",)
                  )
                ],
              ),
              ),
