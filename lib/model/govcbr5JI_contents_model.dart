class Govcbr5jiContentsModel {
  ...
  final String SSD_F_GBN;
  final String SSD_MSG_GI2;
  final String SSD_RPT_DAY;
  final String SSD_5BV_DAY;
  final String SSD_5BV_HM;
  final String SSD_CRG_NM;
  final String SSD_JUNGBAK_COD;
  final String TMPPORT_CD;
  final String SSD_VEHICLE_NO;
  final String SSD_CRG_NM2;
  final String SSD_BWH_NM;
  final String WORK_DIV;
  final String END_SND_CHK;
  final String SSD_ROLE_DIV;
  final String SSD_AGNT_CD;
  final String SSD_AGNT_MK;
  final String SSD_AGNT_NM;

  Govcbr5jiContentsModel({required this.USER_ERP_ID, required this.SSD_F_GBN, required this.SSD_MSG_GI2, required this.SSD_RPT_DAY, required this.SSD_5BV_DAY, required this.SSD_5BV_HM, required this.SSD_CRG_NM, required this.SSD_JUNGBAK_COD, required this.TMPPORT_CD, required this.SSD_VEHICLE_NO, required this.SSD_CRG_NM2, required this.SSD_BWH_NM, required this.WORK_DIV, required this.END_SND_CHK, required this.SSD_ROLE_DIV, required this.SSD_AGNT_CD, required this.SSD_AGNT_MK, required this.SSD_AGNT_NM});
